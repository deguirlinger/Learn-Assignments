...
restart(){
  ...
  render() {
    if (this.state.counter === "You Lose") {
      return (
        <div><h1>Hello</h1></div>
      )}  else {
    return (
      ...
      <h1 className="headerStyle">Treasure Hunt</h1>
        ...
        <p className="counterStyle">{this.state.counter}</p>
        <button className="buttonStyle" onClick={this.restart.bind(this)}><img src="images/restart_icon.png"></img></button>
      </div>
    );
  }
}}
